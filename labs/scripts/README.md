...
| `ch8_dependency_chains.sh` | 8 | Sweeps `cyclelab compute --chains` from 1 to 16 (median of several reps each), showing throughput rise sharply then become uneven as independent work saturates the pipeline and register allocation starts to matter. |
